...
{
    pictures[PIC_CHERRY] = loadTexture("manzana.png");
    pictures[PIC_SNAKE_VERTICAL] = loadTexture("snake_vertical.jpg");
    pictures[PIC_SNAKE_HORIZONTAL] = loadTexture("snake_horizontal.jpg");
    pictures[PIC_SNAKE_HEAD] = loadTexture("snake_head2.png");
    pictures[PIC_BIG_CHERRY] = loadTexture("big_cherry.jpg");
}
